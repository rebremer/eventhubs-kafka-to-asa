...
Also, Azure Databricks works well together with Event Hubs. Follows this tutorial how to process from Event Hubs using Structured Streaming: https://learn.microsoft.com/en-us/azure/databricks/ldp/event-hubs
